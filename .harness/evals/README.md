...
Framework primitive. Each eval measures how the harness behaves
...
| agent   | LLM-driven scenario w/ harness loaded; judge-graded outputs. (Phase 2.1.) | $ per run | no            |
...
.keystone/harness/evals/*/fixture/
```
...
Evals are a framework abstraction; policies (vendored harness
