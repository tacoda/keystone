---
kind: rule
id: rules/keystone-harness-content-state-files
...
source: .harness/guides/idioms/harness-content/state-files.md
generated_by: keystone-project
---

# State files — rules

Full guide: `.harness/guides/idioms/harness-content/state-files.md` (read on demand).
