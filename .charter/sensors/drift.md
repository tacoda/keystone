...
Compares the diff (or full codebase, during audit) against loaded guide rules. Finds violations across all three rule tiers — regular **RULES**, **GOLDEN RULE**, and **IRON LAWS**.
