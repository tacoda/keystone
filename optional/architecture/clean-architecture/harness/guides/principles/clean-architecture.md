...
The rules from [`corpus/principles/clean-architecture.md`](../../corpus/principles/clean-architecture.md).
...
Traces to: [`corpus/principles/clean-architecture.md`](../../corpus/principles/clean-architecture.md).
