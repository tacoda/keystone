...
Every meaningful code change. This is the most volatile layer in the harness — corpus pruning is otherwise rare, but `state/` files turn over continuously by design.
