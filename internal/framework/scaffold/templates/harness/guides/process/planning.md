...
If a discovery from this session is worth keeping, write it to a corpus file or `harness/learning/inbox/` *before* clearing.

The specific context-clear / compaction primitives for your agent live in `harness/adapters/<your-agent>/activation.md`.
