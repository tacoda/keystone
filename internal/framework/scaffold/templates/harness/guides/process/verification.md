...
The binding for your agent lives in `harness/adapters/<your-agent>/lifecycle.md`. Agents that cannot autonomously run shell sensors degrade this action into a checklist + commands surfaced to the human; see the adapter for the exact contract.
...
| Kind | Location |
|---|---|
| State updates | `harness/corpus/state/CODEBASE_STATE.md`, `harness/corpus/state/migrations/active/...` |
