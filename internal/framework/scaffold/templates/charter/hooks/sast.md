...
- **Audit** runs SAST across the entire source tree. Slower, but catches insecurity that pre-existed the charter or that the **drift** sensor doesn't catch because the diff didn't touch it.
