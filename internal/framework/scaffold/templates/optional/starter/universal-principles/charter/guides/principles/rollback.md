...
- **Long-lived flags are tech debt.** A flag that has been on for 100% of traffic for 30 days gets removed in a dedicated PR. The charter's audit action may flag candidates.
