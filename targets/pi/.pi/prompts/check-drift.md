...
2. For each touched file, identify which corpus rules apply (load `harness/corpus/principles/*.md` always; `harness/corpus/idioms/<stack>/*.md` for matching stacks; `harness/corpus/domain/*.md` always).
