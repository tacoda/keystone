...
Read `harness/process/spec.md` and follow its activities exactly. The IRON LAW applies: no proceeding without explicit, testable acceptance criteria.
...
Save the spec to `docs/specs/YYYY-MM-DD-<topic>.md` with the frontmatter shape described in `harness/process/spec.md`.
