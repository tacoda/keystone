...
func TestInit_FreshScaffoldGoldenFiles(t *testing.T) {
	...
	wantFiles := []string{
		...
		".keystone/harness/skills/keystone-bootstrap/SKILL.md",
		".keystone/harness/skills/keystone-spec/SKILL.md",
		".keystone/harness/skills/keystone-orient/SKILL.md",
		".keystone/harness/skills/keystone-check-drift/SKILL.md",
		".keystone/harness/skills/keystone-review/SKILL.md",
		".keystone/harness/skills/keystone-debt-review/SKILL.md",
		".keystone/harness/skills/keystone-mode/SKILL.md",
		".keystone/harness/skills/keystone-learn/SKILL.md",
		".keystone/harness/skills/keystone-synthesize/SKILL.md",
		".keystone/harness/skills/keystone-audit/SKILL.md",
